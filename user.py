    ...
    with connect() as connection:
      with connection.cursor() as cursor:
        ...
        if user_data == None:
          ...
          return cls(first_name=user_data[1], last_name=user_data[2], username=user_data[3], password=user_data[4], admin=user_data[5])
    ...
    with connect() as connection:
      with connection.cursor() as cursor:
        ...
        for user_data in users_data:
          user =cls(first_name=user_data[1], last_name=user_data[2], username=user_data[3], password=user_data[4], admin=user_data[5])
          users.append(user)
    return users
